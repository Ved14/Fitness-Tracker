...
# Chauvenets vriterion (distribution based)
...
# Choosing a method from above

# Testing on single col

col = "gyr_z"
dataset = mark_outliers_chauvenet(df,col)
dataset[dataset["gyr_z_outlier"]]  # boolian indexing will return only true values
